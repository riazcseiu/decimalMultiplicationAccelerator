NUMDIGITS 34           // work with up to 34 digits
			...
			decContext set;                  // working context
				...
				char string1[DECDOUBLE_String]; // 25 for 64 bit String1 is type of numeric string
					...
					decContextDefault(&set, DEC_INIT_DECDOUBLE); // initialize as 64 bit operation
						   ...
						   //
						   //
						   //	  								        			                						    																													    	     		   		        		   	 									    			     												                								        	unsigned long cyclestart,cycleend, modcyclestart,modcycleend,rocccyclestart,rocccycleend,BCD_cyclestart,BCD_cycleend ,aaa,bbb,aaa1,bbb1; // declare for clock test
						   //
						   //
						   //
						   ...
						   //
						   //	  								        			                						    																													    	     		   		        		   	 									    			     												                								        						        	                            		         	                    				         	                  unsigned long BCDDPD = accum_BCDDPD(X, Y);
						   //
						   //	  								        			                						    																													    	     		   		        		   	 									    			     												                								        						        	                            		         	                    				         	                           unsigned long DPDPCD = accum_DPDBCD(X,X);
						   //
						   //	  								        			                						    																													    	     		   		        		   	 									    			     												                								        						        	                            		         	                    				         	                                    bbb1 = read_cycles();
						   //
						   //
						   //
						   //	  								        			                						    																													    	     		   		        		   	 									    			     												                								        						        	                            		         	                    				         	                                      printf("Took %lu cycles to Multiplication  %lu result \n", bbb1 - aaa1, BCDresult1);
						   //
						   //
						   //
						   //	  								        			                						    																													    	     		   		        		   	 									    			     												                								        						        	                            		         	                    				         	                                      X=X+10; Y=Y+10;
