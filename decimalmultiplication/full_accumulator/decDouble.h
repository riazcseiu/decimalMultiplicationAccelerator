...
/* ------------------------------------------------------------------ */
  ...
  typedef union {
    uint8_t   bytes[DECDOUBLE_Bytes];   /* fields: 1, 5, 8, 50 bits */ //r_DECDOUBLE_Bytes  = 8
  ...
  extern decDouble * MdecDoubleMultiply(decDouble *, const decDouble *, const decDouble *, decContext*);//riaz
