...
int main() {
  ...
  unsigned long X =0b1001100110011001100110011001100110011001100110011001100110011001;
	...
	// 0b0011000001001001001101001000001100001000000001100101011101110000;
        // 3_9_8_3_8_4_4_3_8_4_8_9_1_1_1_7_ 
	//3_0_4_9_3_4_8_3_0_8_0_6_5_7_7_0
  unsigned long Y = 0b1001100110011001100110011001100110011001100110011001100110011001;
	//0b0011000001001001001101001000001100001000000001100101011101110000;
        // 0b0011100110000011100001000100001110000100100010010001000100010111;
	//0b0011000001001001001101001000001100001000000001100101011101110000;
  ...
  for (int serial = 0; serial<9; serial ++)
	{	
		...
		printf("Took New riaz %lu cycle for BCD \n start %ld \n end %ld", \
		cycleend_bcd - cyclestart_bcd,cyclestart_bcd, cycleend_bcd);
		X=X+10;
		Y=Y+10;
	}
